    ...
    return (
        <div className='featureBg bg-fixed'>
            <SectionTitle
                ...
                heading="Our Feature"
            ></SectionTitle>
            <div className='md:flex gap-x-[90px] py-8 px-28'>
                ...
                <div className='text-white'>
                    ...
                    <button className="bg-[#7B7B7B] mt-8 hover:bg-slate-400 hover:text-black rounded-3xl border-b-[#AC7C01] border-b-4">Default</button>
                </div>
            </div>
        </div>
    );
